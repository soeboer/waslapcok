...
export async function before(m) {
    ...
    if (!(id in this.tebaklagu)) return m.reply('Soal nya telah berakhir kak')
...
//             m.reply(`*Benar!*\n+${this.tebaklagu[id][2]} XP\n+1 Tiketcoin`)
                        await this.sendButton(m.chat, `*Benar!* +${this.tebaklagu[id][2]} XP\n+1 Tiketcoin`, author, null, [['Main Lagi', '.tebaklagu']], m) 
