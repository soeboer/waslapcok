...
let handler = async (m, { conn, text, usedPrefix }) => {
  ...
  let buttons = [{ buttonText: { displayText: 'Download Video' }, buttonId: `${usedPrefix}ytv ${url}` }]
  let msg = await conn.sendMessage(m.chat, { image: { url: thumbnail }, caption: capt, footer: '_Proses Download MP3..._', buttons }, { quoted: m })
